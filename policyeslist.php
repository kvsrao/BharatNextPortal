    ...
    <body>-->
        <div id="wrapper" class="container">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    $restable = $db->query("select * from policies");
                    if ($restable->result->rowCount() > 0) {
                        $restables = $restable->get();
                        foreach ($restables as $rest) {
                            ?>
                            <tr>
                                <td><?php echo $rest->policyid; ?></td>
                                <td><?php echo $rest->name; ?></td>
                                <td><?php echo $rest->pfrom; ?></td>
                                <td><?php echo $rest->cast; ?></td>
                                <td><?php echo $rest->category; ?></td>
                                <td><?php echo $rest->age; ?></td>
                                <td class="text-center"><a href="postpolicy.php?policyid=<?php echo $rest->policyid; ?> ">  <i class="fas fa-external-link-alt mr-3"></i></a><i class="fas fa-trash-alt"></i></td>
                            </tr>
                           <?php
                         }
                      }else{
